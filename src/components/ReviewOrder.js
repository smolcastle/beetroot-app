...
const ReviewOrder = ({
  ...
  function Cart() {
    return (
      ...
      >
        <path
          d="M3.42871 3.07129H4.09467C5.42695 3.07129 6.5824 3.99207 6.87974 5.29075L7.6521 8.66396"
          stroke="#4E7B36"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M20.8603 9.8557C20.6627 11.9446 20.0703 13.683 19.573 14.7571C19.3174 15.3091 18.8686 15.7377 18.2804 15.8927C17.5606 16.0824 16.3222 16.2859 14.321 16.2859C12.3198 16.2859 11.0815 16.0824 10.3617 15.8927C9.77347 15.7377 9.32454 15.3091 9.069 14.7571C8.46228 13.4465 7.71387 11.1472 7.71387 8.42871H19.4996C20.2886 8.42871 20.9346 9.07023 20.8603 9.8557Z"
          fill="#DCE5D7"
          stroke="#4E7B36"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M9.85756 21.2464C10.7405 21.2464 11.4563 20.5305 11.4563 19.6475C11.4563 18.7645 10.7405 18.0488 9.85756 18.0488C8.97459 18.0488 8.25879 18.7645 8.25879 19.6475C8.25879 20.5305 8.97459 21.2464 9.85756 21.2464Z"
          fill="#DCE5D7"
          stroke="#4E7B36"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M18.7852 21.2464C19.6682 21.2464 20.384 20.5305 20.384 19.6475C20.384 18.7645 19.6682 18.0488 18.7852 18.0488C17.9022 18.0488 17.1865 18.7645 17.1865 19.6475C17.1865 20.5305 17.9022 21.2464 18.7852 21.2464Z"
          fill="#DCE5D7"
          stroke="#4E7B36"
          strokeLinecap="round"
          strokeLinejoin="round"
      ...
      <div className="w-screen h-screen justify-center items-center flex overflow-x-hidden bg-white overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="flex flex-col bg-white0 py-4 px-8 w-[50%] h-[80%] rounded-[8px] border-2 border-slate-50">
          ...
          >
            ...
            >
              <path
                d="M12.5254 7.47461L7.47461 12.5254"
                stroke="#AB224E"
                strokeLinecap="round"
              />
              <path
                d="M12.5254 12.5254L7.47461 7.47461"
                stroke="#AB224E"
                strokeLinecap="round"
              />
            </svg>
                  ...
                  <>
                    <div className="flex text-[12px] text-gum justify-between items-center mb-4 px-2">
                      ...
                      <div className="flex flex-col justify-center">
                        <svg
                          className={`place-self-end cursor-pointer ${
                            orderCreated ? 'opacity-25 cursor-default' : ''
                          }`}
                          width="12"
                          height="12"
                          viewBox="0 0 12 12"
                    ...
                    <div className="flex text-[12px] text-gum justify-between items-center mb-4 px-2">
                      ...
                      <div className="flex flex-col justify-center">
                        <svg
                          ...
                          onClick={() => {
                            if (!orderCreated) {
                              removeConsideration(consideration.id);
                            }
                          }}
                        >
                          <path
          ...
          {orderCreated && (
            <button className="w-full border-[1px] border-gum border-solid rounded-[4px] text-[14px] text-gum h-10 mt-5">
              {'YOUR ORDER HAS BEEN CREATED!'}
            </button>
          )}
          <p className="text-[10px] mt-4 text-gray1">
            When you click the above button, this order request will be sent to
            the given recipient. Once they fulfil your request, this transcation
