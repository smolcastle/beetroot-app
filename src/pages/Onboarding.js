    ...
    <div className={`flex justify-center items-center bg-white0 w-screen pl-[4%] overflow-x-hidden`}>
        ...
        <div className='font-rubrik w-[50%] justify-evenly h-full'>
            ...
            <div className='text-gray1 mt-[64px] pb-[48px]'>
                ...
                <button className='border-b border-gray1 border-solid ml-[16px]' onClick={() => {updateUserOnboarded()}}>Next</button>
            </div>
        </div>
        <div className='flex w-[50%] flex-col'>
            <div className='flex flex-col mt-[48px] text-gray1'>
                ...
                <div className='flex justify-start items-center w-[45%]'>
                    <div className='flex mr-[16px]'>
                        <input type="radio" className='mr-[4px] border-[1px] border-gum border-solid bg-gumtint checked:text-gum' id="wallet address" value="Wallet address" name='display' onChange={(e) => {setDisplayName( e.target.value);}}/>
                        <label className='text-[14px]' htmlFor="wallet address">Wallet address</label>
                    </div>
                    <div className='flex'>
                        <input type="radio" className='mr-[4px] border-[1px] border-gum border-solid bg-gumtint checked:text-gum' id="ENS Name" value="ENS Name" name='display' onChange={(e) => {setDisplayName( e.target.value);}}/>
                        <label className='text-[14px]' htmlFor="ENS Name">ENS Name</label>
                    </div>
                </div>
            </div>
            <div className='text-gray1 mt-[24px]'>
                ...
                <div className='flex mt-[8px]'>
                    <input type="radio" className='mr-[4px] border-[1px] border-gum border-solid bg-gumtint checked:text-gum' id='telegram' name='contact'/>
                    <label htmlFor='telegram' className='text-[14px]'>{"Telegram:"}</label>
                </div>
                <div className='flex items-center w-[300px]'>
                    ...
                    <input className='w-[285px] outline-none rounded-[4px] mr-[8px] text-[14px] bg-gumtint/[0.2] text-gum placeholder:text-gum/[0.5] p-2'
                    placeholder='your username'
                    onChange={(e) => {setTelegram( e.target.value)}}/>
                </div>
                <div className='flex mt-[8px]'>
                    <input type="radio" className='mr-[4px] border-[1px] border-gum border-solid bg-gumtint checked:text-gum' id='email' name='contact'/>
                    <lable htmlFor='email' className='text-[14px]'>{"Email:"}</lable>
                </div>
                <div className='flex items-center w-[300px]'>
                    <input className='outline-none rounded-[4px] w-full mr-[8px] text-[14px] bg-gumtint/[0.2] text-gum placeholder:text-gum/[0.5] p-2'
                    placeholder='Your Email Address'
                    onChange={(e) => {setEmail( e.target.value)}}/>
                </div>

                <div className='flex mt-[4px]'>
                    <input type="radio" onClick={() => {setLater(true)}} className='mr-[4px] border-[1px] border-gum border-solid bg-gumtint checked:text-gum' id='later' name='contact'/>
                    <label htmlFor='later' className='text-[14px]'>{"Choose later"}</label>
                </div>
            </div>
            <div className='text-gray1 mt-[24px]'>
        ...
        <div className='flex w-screen pl-[12%] pt-[8%] overflow-x-hidden '>
            ...
            {"You can now begin chatting with other users to negotiate NFT trades and deals."}
                ...
                <button onClick={() => {setOnboarded(true); }} className="text-gum underline text-[14px] mr-[4px]">skip tour</button>
