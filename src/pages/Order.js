                    ...
                    return (
                        ...
                        <div className='flex justify-between '>
                            <div className='w-[30%] flex flex-col'>
                                ...
                                <h1 className='text-gray2 text-[10px]'>Order Expires in 20 days</h1>
                            ...
                            <div>
                                {(order.to == sender) && <button className='bg-parsleytint text-[12px] py-1 px-3 text-parsley rounded-[4px] mr-3' onClick={() => fulfillFunc(order.id)}>Fulfill</button>}
                                <button className='bg-gumtint py-1 px-3 text-[12px] text-gum rounded-[4px]'>Reject</button>
