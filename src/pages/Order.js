...
const Order = ({sender, truncate, receiver}) => {
    ...
    const temp1 = createOrder()
    console.log(temp1)
    // console.log(temp1.actions)
    // if(temp1.type == "create"){
    //     const approve = temp1.actions[1].createOrder()
    //     console.log(approve)
    // }
    // const s = seaport.signer.sendTransaction(temp1);
    // console.log(s)
